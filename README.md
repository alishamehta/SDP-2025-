# SDP-2025-
Adaptive Profiling and Optimization at the Operator-Level for Machine Learning Models 
...
Non-GEMM (softmax, layer normalization, element-wise ops)
...
DistilBERT on LIAR (baseline): https://www.kaggle.com/code/adamhsueh/distilbertmodel
